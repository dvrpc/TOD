...
$('#data-btn').click(function (e) {
  e.preventDefault()
  $('.btn-group a[href="#data-main"]').tab('show') // Select tab by name
});

$('#chart-btn').click(function (e) {
  e.preventDefault()
  $('.btn-group a[href="#chart-main"]').tab('show') // Select tab by name
});
...
//});
 // legend toggle
    ...
    function identify(e) {
        ...
        var existinginfo ="<div><b>Transit Service Quality:</b>"+(props.TCI_Data)+" TCI Score</div>"
                         +"<div><b>Job Access:</b>"+(props.Job_Data)+" jobs accessible within 30 minute transit ride</div>"
                         +"<div><b>Travel Time:</b>"+(props.Time_Data)+" transit to auto travel time ratio</div>"
                         +"<div><b>Intensity (Residents + Employees):</b>"+(props.Int_Data)+" jobs accessible within 30 minute transit ride</div>"
                         +"<div><b>Households with 0 or 1 Car:</b>"+(props.Car_Data)+" %</div>"
                         +"<div><b>Non-Car C ommuters:</b>"+(props.Com_Data)+" jobs accessible within 30 minute transit ride</div>"
                         +"<div><b>Walk Score™: :</b>"+(props.Walk_data)+" jobs accessible within 30 minute transit ride</div>"
